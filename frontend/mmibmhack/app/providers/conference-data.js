...
export class ConferenceData {
  ...
  load() {
    ...
    return new Promise(resolve => {
      ...
      this.http.get('data/data.json').subscribe(res => {
        // we've got back the raw data, now generate the core roadmap data
  ...
  processData(data) {
    ...
    // loop through each day in the roadmap
    data.roadmap.forEach(day => {
